...
func (c *CSMSHandler) OnNotifyDisplayMessages(ctx context.Context, chargingStationID string, request *display.NotifyDisplayMessagesRequest) (response *display.NotifyDisplayMessagesResponse, err error) {
