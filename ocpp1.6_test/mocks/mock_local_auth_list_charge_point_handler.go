...
func (_m *MockLocalAuthListChargePointHandler) OnGetLocalListVersion(ctx context.Context, request *localauth.GetLocalListVersionRequest) (*localauth.GetLocalListVersionConfirmation, error) {
