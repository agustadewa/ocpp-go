...
// WriteWithContext provides a mock function with given fields: ctx, webSocketId, data
func (_m *MockServer) WriteWithContext(ctx context.Context, webSocketId string, data []byte) error {
	ret := _m.Called(ctx, webSocketId, data)

	if len(ret) == 0 {
		panic("no return value specified for WriteWithContext")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, []byte) error); ok {
		r0 = rf(ctx, webSocketId, data)
	} else {
		r0 = ret.Error(0)
	}
...
// MockServer_WriteWithContext_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WriteWithContext'
type MockServer_WriteWithContext_Call struct {
	*mock.Call
}

// WriteWithContext is a helper method to define mock.On call
//   - ctx context.Context
//   - webSocketId string
//   - data []byte
func (_e *MockServer_Expecter) WriteWithContext(ctx interface{}, webSocketId interface{}, data interface{}) *MockServer_WriteWithContext_Call {
	return &MockServer_WriteWithContext_Call{Call: _e.mock.On("WriteWithContext", ctx, webSocketId, data)}
}

func (_c *MockServer_WriteWithContext_Call) Run(run func(ctx context.Context, webSocketId string, data []byte)) *MockServer_WriteWithContext_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockServer_WriteWithContext_Call) Return(_a0 error) *MockServer_WriteWithContext_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockServer_WriteWithContext_Call) RunAndReturn(run func(context.Context, string, []byte) error) *MockServer_WriteWithContext_Call {
	_c.Call.Return(run)
	return _c
}
