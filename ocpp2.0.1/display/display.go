...
type CSMSHandler interface {
	...
	OnNotifyDisplayMessages(ctx context.Context, chargingStationID string, request *NotifyDisplayMessagesRequest) (response *NotifyDisplayMessagesResponse, err error)
}
...
type ChargingStationHandler interface {
	...
	OnClearDisplay(ctx context.Context, request *ClearDisplayRequest) (confirmation *ClearDisplayResponse, err error)
	// OnGetDisplayMessages is called on a charging station whenever a GetDisplayMessagesRequest is received from the CSMS.
	OnGetDisplayMessages(ctx context.Context, request *GetDisplayMessagesRequest) (confirmation *GetDisplayMessagesResponse, err error)
	// OnSetDisplayMessage is called on a charging station whenever a SetDisplayMessageRequest is received from the CSMS.
	OnSetDisplayMessage(ctx context.Context, request *SetDisplayMessageRequest) (response *SetDisplayMessageResponse, err error)
}
