...
func (c *CSMSHandler) OnBootNotification(ctx context.Context, chargingStationID string, request *provisioning.BootNotificationRequest) (response *provisioning.BootNotificationResponse, err error) {
...
func (c *CSMSHandler) OnNotifyReport(ctx context.Context, chargingStationID string, request *provisioning.NotifyReportRequest) (response *provisioning.NotifyReportResponse, err error) {
