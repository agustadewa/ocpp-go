...
func (c *CSMSHandler) OnLogStatusNotification(ctx context.Context, chargingStationID string, request *diagnostics.LogStatusNotificationRequest) (response *diagnostics.LogStatusNotificationResponse, err error) {
...
func (c *CSMSHandler) OnNotifyCustomerInformation(ctx context.Context, chargingStationID string, request *diagnostics.NotifyCustomerInformationRequest) (response *diagnostics.NotifyCustomerInformationResponse, err error) {
...
func (c *CSMSHandler) OnNotifyEvent(ctx context.Context, chargingStationID string, request *diagnostics.NotifyEventRequest) (response *diagnostics.NotifyEventResponse, err error) {
...
func (c *CSMSHandler) OnNotifyMonitoringReport(ctx context.Context, chargingStationID string, request *diagnostics.NotifyMonitoringReportRequest) (response *diagnostics.NotifyMonitoringReportResponse, err error) {
