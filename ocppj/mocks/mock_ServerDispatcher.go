...
// SendRequestWithContext provides a mock function with given fields: ctx, clientID, req
func (_m *MockServerDispatcher) SendRequestWithContext(ctx context.Context, clientID string, req ocppj.RequestBundle) error {
	ret := _m.Called(ctx, clientID, req)

	if len(ret) == 0 {
		panic("no return value specified for SendRequestWithContext")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, ocppj.RequestBundle) error); ok {
		r0 = rf(ctx, clientID, req)
	} else {
		r0 = ret.Error(0)
	}
...
// MockServerDispatcher_SendRequestWithContext_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SendRequestWithContext'
type MockServerDispatcher_SendRequestWithContext_Call struct {
	*mock.Call
}

// SendRequestWithContext is a helper method to define mock.On call
//   - ctx context.Context
//   - clientID string
//   - req ocppj.RequestBundle
func (_e *MockServerDispatcher_Expecter) SendRequestWithContext(ctx interface{}, clientID interface{}, req interface{}) *MockServerDispatcher_SendRequestWithContext_Call {
	return &MockServerDispatcher_SendRequestWithContext_Call{Call: _e.mock.On("SendRequestWithContext", ctx, clientID, req)}
}

func (_c *MockServerDispatcher_SendRequestWithContext_Call) Run(run func(ctx context.Context, clientID string, req ocppj.RequestBundle)) *MockServerDispatcher_SendRequestWithContext_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(ocppj.RequestBundle))
	})
	return _c
}

func (_c *MockServerDispatcher_SendRequestWithContext_Call) Return(_a0 error) *MockServerDispatcher_SendRequestWithContext_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockServerDispatcher_SendRequestWithContext_Call) RunAndReturn(run func(context.Context, string, ocppj.RequestBundle) error) *MockServerDispatcher_SendRequestWithContext_Call {
	_c.Call.Return(run)
	return _c
}
