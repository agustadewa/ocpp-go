...
type ChargingStationHandler interface {
	...
	OnRequestStartTransaction(ctx context.Context, request *RequestStartTransactionRequest) (response *RequestStartTransactionResponse, err error)
	...
	OnRequestStopTransaction(ctx context.Context, request *RequestStopTransactionRequest) (response *RequestStopTransactionResponse, err error)
	// OnTriggerMessage is called on a charging station whenever a TriggerMessageRequest is received from the CSMS.
	OnTriggerMessage(ctx context.Context, request *TriggerMessageRequest) (response *TriggerMessageResponse, err error)
	// OnUnlockConnector is called on a charging station whenever a UnlockConnectorRequest is received from the CSMS.
	OnUnlockConnector(ctx context.Context, request *UnlockConnectorRequest) (response *UnlockConnectorResponse, err error)
}
