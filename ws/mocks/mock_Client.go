...
// WriteWithContext provides a mock function with given fields: ctx, data
func (_m *MockClient) WriteWithContext(ctx context.Context, data []byte) error {
...
// MockClient_WriteWithContext_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WriteWithContext'
type MockClient_WriteWithContext_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - data []byte
func (_e *MockClient_Expecter) WriteWithContext(ctx interface{}, data interface{}) *MockClient_WriteWithContext_Call {
	return &MockClient_WriteWithContext_Call{Call: _e.mock.On("WriteWithContext", ctx, data)}
}

func (_c *MockClient_WriteWithContext_Call) Run(run func(ctx context.Context, data []byte)) *MockClient_WriteWithContext_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClient_WriteWithContext_Call) Return(_a0 error) *MockClient_WriteWithContext_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_WriteWithContext_Call) RunAndReturn(run func(context.Context, []byte) error) *MockClient_WriteWithContext_Call {
	_c.Call.Return(run)
	return _c
}
