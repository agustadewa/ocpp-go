...
// SendRequestWithContext provides a mock function with given fields: ctx, req
func (_m *MockClientDispatcher) SendRequestWithContext(ctx context.Context, req ocppj.RequestBundle) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, ocppj.RequestBundle) error); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Error(0)
	}
...
// MockClientDispatcher_SendRequestWithContext_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SendRequestWithContext'
type MockClientDispatcher_SendRequestWithContext_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - req ocppj.RequestBundle
func (_e *MockClientDispatcher_Expecter) SendRequestWithContext(ctx interface{}, req interface{}) *MockClientDispatcher_SendRequestWithContext_Call {
	return &MockClientDispatcher_SendRequestWithContext_Call{Call: _e.mock.On("SendRequestWithContext", ctx, req)}
}

func (_c *MockClientDispatcher_SendRequestWithContext_Call) Run(run func(ctx context.Context, req ocppj.RequestBundle)) *MockClientDispatcher_SendRequestWithContext_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(ocppj.RequestBundle))
	})
	return _c
}

func (_c *MockClientDispatcher_SendRequestWithContext_Call) Return(_a0 error) *MockClientDispatcher_SendRequestWithContext_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClientDispatcher_SendRequestWithContext_Call) RunAndReturn(run func(context.Context, ocppj.RequestBundle) error) *MockClientDispatcher_SendRequestWithContext_Call {
	_c.Call.Return(run)
	return _c
}
