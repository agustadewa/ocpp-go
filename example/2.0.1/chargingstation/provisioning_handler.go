...
// func (handler *ChargingStationHandler) OnChangeConfiguration(ctx context.Context, request *core.ChangeConfigurationRequest) (confirmation *core.ChangeConfigurationConfirmation, err error) {
...
// }
//
// func (handler *ChargingStationHandler) OnGetConfiguration(ctx context.Context, request *core.GetConfigurationRequest) (confirmation *core.GetConfigurationConfirmation, err error) {
