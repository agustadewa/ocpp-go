...
func (_m *MockRemoteTriggerChargePointHandler) OnTriggerMessage(ctx context.Context, request *remotetrigger.TriggerMessageRequest) (*remotetrigger.TriggerMessageConfirmation, error) {
